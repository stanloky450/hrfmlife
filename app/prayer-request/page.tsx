				...
				<div className="container mx-auto px-4 relative z-10">
					...
					>
						...
						<p className="text-xl text-gray-200 leading-relaxed">
							Our prayer team is here for you. Share your prayer needs with us,
							...
							<form onSubmit={handleSubmit} className="space-y-6">
								...
								{submitStatus === "success" && (
									<div className="bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-lg">
										✓ Your prayer request has been submitted. We will be praying
										for you.
									</div>
								)}
						...
						>
							<div className="bg-white rounded-2xl shadow-lg p-8">
								...
								<p className="text-gray-600 leading-relaxed mb-4">
									Every prayer request submitted is prayed over by our dedicated
									prayer team. We believe in the power of corporate prayer and
									will stand with you in faith.
								</p>
								<p className="text-gray-600 leading-relaxed">
									For urgent prayer needs, please join us on our Friday night
