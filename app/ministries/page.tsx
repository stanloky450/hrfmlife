...
import { FaChurch, FaTshirt, FaHandsHelping, FaPrayingHands, FaBook, FaGlobeAmericas, FaHeart, FaUsers } from 'react-icons/fa';
    ...
    <div className="pt-20">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Core Ministry Programs</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Each ministry is designed to fulfill our mission of spreading God's love and meeting people's needs
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our ministry spans multiple countries, touching lives across continents
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              {
                country: 'Jamaica',
                locations: ['Kingston', 'Spanish Town', 'St Mary', 'St Thomas', 'Manchester'],
                icon: '🇯🇲',
              },
              {
                country: 'Bahamas',
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">{location.country}</h3>
          ...
          >
            <div className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white rounded-3xl p-12 text-center">
              ...
              <p className="text-xl text-gray-200 mb-8 leading-relaxed">
                Whether through prayer, volunteering, or financial support, there are many ways to join
                our mission and make a difference in people's lives.
              </p>
