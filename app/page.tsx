...
import { FaGlobeAmericas, FaTshirt, FaHandsHelping, FaChurch, FaArrowRight } from 'react-icons/fa';
  ...
  const upcomingEvents = [
    {
      ...
      excerpt: 'Join us every Friday night for powerful prayer and worship. Open to all who desire the word of God.',
    ...
    },
    {
      ...
      excerpt: 'Deep dive into the scriptures with our international community of believers.',
    ...
    },
    {
      ...
      excerpt: 'Join us for our annual all-night service filled with worship, prayer, and celebration.',
  ...
  const latestPosts = [
    {
      ...
      excerpt: 'Discover how prayer and fasting can transform your spiritual life and bring breakthrough in difficult situations.',
      author: 'HRFM Team',
    ...
    },
    {
      ...
      excerpt: 'Our outreach continues to expand, providing essential items to underserved communities across multiple countries.',
    ...
    },
    {
      ...
      excerpt: 'Read about miraculous healing testimonies from our prayer line participants and how God continues to move.',
      author: 'Community',
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Healing Rain Falling Ministries (HRFM) is a non-denomination ministry and a 501(c)(3) nonprofit organization.
              We believe in the power of prayer, fasting, and understanding the scriptures. Our international team spans across
              the Bahamas, Jamaica, Canada, and the United States, united in fulfilling Isaiah 61:1-5 KJV and Matthew 10:8.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 font-[family-name:var(--font-playfair)]">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Ministries</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Serving communities worldwide through prayer, education, and humanitarian aid
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 text-gray-200">
              Whether you need prayer, want to volunteer, or wish to support our mission,
              there's a place for you in the HRFM family.
            </p>
