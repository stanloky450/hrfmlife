	...
	const events = [
		{
			...
			excerpt:
				"Join us every Friday night for powerful prayer, worship, and the word of God. Open to all believers seeking spiritual growth and fellowship.",
		...
		},
		{
			...
			excerpt:
				"Deep dive into the scriptures with our international community of believers. Experience transformative teaching and discussion.",
		...
		},
		{
			...
			excerpt:
				"Join us for our annual all-night service filled with worship, prayer, testimonies, and celebration of God's faithfulness.",
		...
		},
		{
			...
			excerpt:
				"Join us as we distribute clothing, food, and essentials to underserved communities in Chicago.",
		...
		},
		{
			...
			excerpt:
				"Special prayer and worship service for young people seeking God's direction and purpose.",
		...
		},
		{
			...
			excerpt:
				"Acts of Kindness outreach program serving communities in Kingston and Spanish Town.",
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div className="bg-white rounded-xl p-6 shadow-md">
									...
									<p className="text-sm text-gray-500 mt-3">
										Open to all who desire the word of God, prayer,
										encouragement, and deliverance
									</p>
								</div>
								...
								<div className="bg-white rounded-xl p-6 shadow-md">
									...
									<p className="text-gray-700 mb-3">
										Bible Study via Conference Line
									</p>
									...
									<p className="text-sm text-gray-500 mt-3">
										Deep scriptural teaching and group discussion for spiritual
										growth
									</p>
								</div>
							</div>
				...
				<div className="container mx-auto px-4">
					...
					>
						...
						<p className="text-lg text-gray-600 max-w-2xl mx-auto">
							Stay connected with our community through prayer meetings,
							outreach programs, and special services
						</p>
					</motion.div>
					...
					>
						<div className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white rounded-3xl p-12 text-center">
							...
							<p className="text-xl text-gray-200 mb-8">
								Donst miss out on our upcoming events and programs. Subscribe to
								our updates or follow us on social media to stay connected.
							</p>
